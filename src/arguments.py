...
def main_parser():
    ...
    dd_config_group.add_argument(
        "--product-platform", type=str, default=None, help="Product platform"
    )
    ...
    test_config_group.add_argument(
        "--engagement-name", type=str, default="CI/CD Engagement", help="Engagement name"
    )
    test_config_group.add_argument("--test-name", type=str, default=None, help="Test name")
    test_config_group.add_argument(
        "--test-type-name", type=str, default=None, help="Test type name"
    )
    test_config_group.add_argument(
        "--static-tool", action="store_true", default=False, help="Is static tool?"
    )
    test_config_group.add_argument(
        "--dynamic-tool", action="store_true", default=False, help="Is dynamic tool?"
    )
    test_config_group.add_argument(
        "--tool-configuration-name", type=str, default=None, help="Tool configuration name"
    )
    test_config_group.add_argument(
    ...
    scan_settings_group.add_argument(
        "--reimport-condition",
        type=str,
        default=ReimportConditions.DEFAULT.value,
    ...
    ci_info_group.add_argument("--build-id", type=str, default=None, help="Build ID")
    ci_info_group.add_argument("--commit-hash", type=str, default=None, help="Commit hash")
    ci_info_group.add_argument("--branch-tag", type=str, default=None, help="Branch or tag")
    ci_info_group.add_argument("--scm-uri", type=str, default=None, help="SCM URI")
    ...
    general_group.add_argument(
        "-i", "--insecure", action="store_false", default=False, help="Disable ssl verification."
    )
    ...
    dtrack_parser.add_argument(
        "--dtrack-api-url", type=str, default=None, help="Dependency-Track API URL"
    )
    dtrack_parser.add_argument(
        "--dtrack-api-key", type=str, default=None, help="Dependency-Track API Key"
    )
    dtrack_parser.add_argument(
        "--dtrack-project-name", type=str, default=None, help="Dependency-Track project name"
    )
    dtrack_parser.add_argument(
        "--dtrack-project-version", type=str, default=None, help="Dependency-Track project version"
    )
    dtrack_parser.add_argument(
        "--dtrack-reimport", action="store_true", default=True, help="Dependency-Track reimport"
    )
    dtrack_parser.add_argument(
        "--dtrack-reactivate", action="store_true", default=True, help="Dependency-Track reactivate"
    )
